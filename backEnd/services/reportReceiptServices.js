...
async function exportReceiptReport() {
    const scriptPath = path.join(__dirname, '../reports/export_receipt.py');
    ...
    return new Promise((resolve, reject) => {
        ...
        pythonProcess.end((err, code, signal) => {
            ...
            if(code === 0 && output.includes("STATUS: SUCCESS")){
                ...
                resolve(path.join(__dirname, '../../relatorios/recebimentoTaloes.csv'));
            }else{
